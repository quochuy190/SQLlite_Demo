...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    public ProductEntity getProduc(int id) {
        ...
        //ProductEntity product = new ProductEntity(cursor.getInt(0), cursor.getString(1), Integer.parseInt(cursor.getString(2)), cursor.getString(3));
